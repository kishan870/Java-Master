...
public class TreeSetMain {
    public static void main(String[] args) {
        ...
        //Strings have natural sort order
        ...
        //Any changes to descendingSet will also get reflected in fullSet
        Contact lastContact = descendingSet.pollLast();
        System.out.println("Removed contact: " + lastContact);
        System.out.println("-".repeat(50) + "Descending Set");
        descendingSet.forEach(System.out::println);
        System.out.println("-".repeat(50) + "Original Set");
        fullSet.forEach(System.out::println);

        //Head Set and Tail Set methods
        System.out.println("-".repeat(50));
