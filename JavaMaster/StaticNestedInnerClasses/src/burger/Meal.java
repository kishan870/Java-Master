...
public class Meal {
    ...
    public Meal(double converstionRate) {
    ...
    public double getTotal() {
        ...
        return Item.getPrice(total, converstionRate);
    }
    ...
    private class Item {
        ...
        public Item(String name, String type) {
            this(name, type, (type == "burger")? Meal.this.price: 0);
        }
        ...
        @Override
        public String toString() {
            return "%10s%15s $%.2f".formatted(type, name, getPrice(price, converstionRate));
        }
